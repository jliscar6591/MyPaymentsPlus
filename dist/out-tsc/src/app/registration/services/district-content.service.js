...
var DistrictContentService = /** @class */ (function () {
    function DistrictContentService(http, utilityService) {
        this.http = http;
    ...
    DistrictContentService.prototype.getContent = function (districtContentKey, loginResponse) {
        var _this = this;
        var newJwt;
        ...
        var Url = app_settings_1.Constants.WebApiUrl.Auth + '/StudentMessage/' + districtContentKey; // URL to web API
    ...
    DistrictContentService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http,
            index_1.UtilityService])
    ], DistrictContentService);
    return DistrictContentService;
}());
exports.DistrictContentService = DistrictContentService;
//# sourceMappingURL=district-content.service.js.map